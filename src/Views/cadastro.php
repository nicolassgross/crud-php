...
<body>
    <form class="form-horizontal" action="../process/process_cadastro.php" method="POST" enctype="multipart/form-data">
        <div class="panel panel-primary">
            <div class="panel-heading">Cadastro de Pessoa</div><br><br>
                <div class="form-group">
                    <div style="padding-left:20%">
                        <div class="form-group">
                        <label class="col-md-2 control-label">Nome<h8> *</h8></label>
                        <div class="col-md-5">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input id="nome" name="nome" placeholder="João da Silva" class="form-control input-md" required="" type="text">
                            </div>
                        </div>
                    </div>
                <div class="form-group">
